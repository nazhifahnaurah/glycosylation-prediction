...
call_datamrmr<-read.csv("D:/baru/datamrmr50.csv", header = TRUE, sep=",")[,-1]
...
for (i in 1:5) {
  ...
  fileName1='idpn_Linear_C_mrmr50.txt'
...
for (i in 1:5) {
  ...
  fileName3='idpn_sigmoid_C_mrmr50.txt'
...
for (i in 1:5) {
  ...
  fileName4='idpn_gausian_C_mrmr50.txt'
